            ...
            <div className={styles["flip-card"]}>
                <div className={styles["flip-card-inner"]}>
                    <div className={styles["flip-card-front"]}>
                        <div className='w-full h-full grid grid-cols-3 grid-rows-3 p-6 rounded-2xl border-2 justify-around items-start border-slate-600 bg-slate-800 overflow-hidden'>
                    ...
                    <div className={styles["flip-card-back"]}>
                        <div className='w-full h-full flex rounded-2xl border-2 border-slate-600 bg-slate-800 overflow-hidden p-4 px-8'>
