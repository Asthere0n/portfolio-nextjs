...
export default function Stack() {
    return (
        <div className='w-full min-h-[100dvh] flex flex-col lg:flex-row justify-center items-start px-28 pt-16'>
            <div className='m-8 w-[60%] '>
                <h2 className='text-5xl text-slate-200'>But what's <span className='text-yellow-400'>MERN</span>?</h2>
            ...
            <div className='m-8'>
                <h3 className='text-3xl mb-8 text-slate-200'>Other <span className='text-yellow-400'>Technologies</span> I use</h3>
